...
<!-- SECTION -->
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <h3>Soup Pedas Daging Kambing.</h3>
                    <p>Bahan-bahan: <br>
                        - 300 gram daging kambing <br>
                        - 1 batang serai <br>
                        - 1 buah tomat, dipotong-potong <br>
                        - 1 sdt penyedap rasa <br>
                        - 2 lembar daun salam <br>
                        - 3 sdm kecap manis <br>
                        - Garam dan gula secukupnya <br><br>

                        Bahan bumbu kasar: <br>
                        - 1 butir bawang bombay <br>
                        - 10 buah cabai merah <br>
                        - 10 buah cabai rawit <br>
                        - 3 lembar daun jeruk <br>
                        - 4 buah bawang merah <br>
                        - 4 siung bawang putih <br><br>

                        Cara membuat: <br>
                        1. Rebus daging kambing hingga empuk. Tiriskan. <br>

                        2. Tumis bumbu kasar sampai harum. <br>

                        3. Masukkan daging ke dalam tumisan. Aduk rata. <br>

                        4. Tambahkan kecap, daun salam, serai, potongan tomat, penyedap rasa, gula, dan garam. <br>

                        5. Masak hingga bumbu meresap. Tambahkan air bila perlu. Koreksi rasa. Angkat dan sajikan. <br>
                    </p>
                </div>
                <div class="col-md-4">
                    <!-- ad widget-->
